export default function Sidebar() {
  return (
    <div className="flex justify-start items-start w-60 h-[956px] gap-2.5 px-[15px] py-5 bg-white">
      <div className="flex flex-col justify-start items-start flex-grow-0 flex-shrink-0 w-[200px] gap-[5px]">
        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[210px] relative gap-[5px] px-[15px] rounded-[10px] bg-[#5856d6]">
          <svg
            width={28}
            height={29}
            viewBox="0 0 28 29"
          ...
          <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5 p-2.5">
            <p className="flex-grow-0 flex-shrink-0 text-xl font-semibold text-left capitalize text-white">
              인기 차트
            </p>
          </div>
        </div>
        <div className="flex justify-start items-center flex-grow-0 flex-shrink-0 w-[210px] relative gap-[5px] px-[15px]">
          <svg
            width={28}
            height={29}
            viewBox="0 0 28 29"
          ...
          <div className="flex justify-start items-start self-stretch flex-grow-0 flex-shrink-0 relative gap-2.5 p-2.5">
            <p className="flex-grow-0 flex-shrink-0 text-xl text-left capitalize text-[#5856d6]">
              노래 분석하기
            </p>
          </div>
        </div>
        ...
        <div className="flex justify-end items-center flex-grow-0 flex-shrink-0 w-[210px] h-10 relative gap-2.5">
          <svg
            width={24}
            height={24}
            viewBox="0 0 24 24"
          ...
          >
            <path
              d="M12.5863 8.70621L9.99625 11.2962C9.60625 11.6862 9.60625 12.3162 9.99625 12.7062L12.5863 15.2962C13.2163 15.9262 14.2963 15.4762 14.2963 14.5862V9.40621C14.2963 8.51621 13.2163 8.07621 12.5863 8.70621Z"
              fill="#5856D6"
            />
          </svg>
        </div>
